...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
		...
		function r(e) {
			...
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { fetching: !1, likeList: [], dislikeList: [], index: -1, current: [] },
		...
		function r(e) {
			...
			function t(e) {
				(0, c.default)(this, t);var n = (0, h.default)(this, (t.__proto__ || (0, s.default)(t)).call(this, e));return n.handleClickOne = n.handleClickOne.bind(n), n.handleClickTwo = n.handleClickTwo.bind(n), n;
					...
					var t = this;k.default.post("/Faces/api/train/", { choice: "like", image_file: this.props.current[this.props.index + 1] }).done(function (e) {
						t.props.populateDone(e.images);
					}), this.props.swipeRight(this.props.current[this.props.index + 1]);
				} }, { key: "handleClickTwo", value: function (e) {
					var t = this;k.default.post("/Faces/api/train/", { choice: "dislike", image_file: this.props.current[this.props.index + 1] }).done(function (e) {
						t.props.populateDone(e.images);
					}), this.props.swipeRight(this.props.current[this.props.index + 1]);

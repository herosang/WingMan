		...
		function r(e) {
			...
			function t(e) {
				(0, c.default)(this, t);var n = (0, h.default)(this, (t.__proto__ || (0, s.default)(t)).call(this, e));return n.handleClickOne = n.handleClickOne.bind(n), n.handleClickTwo = n.handleClickTwo.bind(n), n;
					...
					this.props.swipeRight(this.props.current[this.props.index + 1]), k.default.post("/Faces/api/train/", { choice: "like", image_file: this.props.current[this.props.index] }).done(function (e) {
						this.props.populateDone(e.images);
					});
				} }, { key: "handleClickTwo", value: function (e) {
					this.props.swipeRight(this.props.current[this.props.index + 1]), k.default.post("/Faces/api/train/", { choice: "dislike", image_file: this.props.current[this.props.index] }).done(function (e) {
						this.props.populateDone(e.images);
					});
